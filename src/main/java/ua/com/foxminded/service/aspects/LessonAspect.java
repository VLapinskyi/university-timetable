    ...
    void beforeCreateAdvice (JoinPoint joinPoint) {
        ...
        try {
            ...
            if (!violations.isEmpty()) {
                ...
                ConstraintViolationException exception = new ConstraintViolationException("When create the lesson is not valid: " + errorMessages, violations);
                LOGGER.error("The lesson {} is not valid when create. There are errors: {}.", lesson, errorMessages, exception);
                throw exception;
            }
            ...
            if (lessonId != 0) {
                ...
                LOGGER.error("A lesson {} has wrong id {} which is not equal zero when create.", lesson, lessonId, exception);
                throw exception;
            }
    ...
    void beforeUpdateAdvice(JoinPoint joinPoint) {
        ...
        try {
            ...
            if (!violations.isEmpty()) {
                ...
                ConstraintViolationException exception = new ConstraintViolationException("When update the lesson is not valid:" + errorMessages, violations);
                LOGGER.error("The lesson {} is not valid when update. There are errors: {}.", lesson, errorMessages, exception);
                throw exception;
            }
            ...
            if (lessonId < 1) {
                IllegalArgumentException exception = new IllegalArgumentException("A lesson id isn't positive for existing object.");
                LOGGER.error("An updated lesson {} has wrong id {} which is not positive.", lesson, lessonId, exception);
                throw exception;
            }
        } catch (IllegalArgumentException illegalArgumentException) {
