...
public class ScheduleControllerAspect {
    ...
    public String aroundGetLecturerWeekSchedule(ProceedingJoinPoint proceedingJoinPoint) throws Throwable {
        ...
        try {
            ...
            if (LOGGER.isDebugEnabled()) {            
                LOGGER.debug("The result model of searching a week schedule for a lecturer with id {} is {}.", lecturerId, model.asMap());
            }            
            ...
            if (serviceException.getException() instanceof DAOException) {
                LOGGER.error("There are some errors in dao layer when get week schedule for a lecturer with id {}.", lecturerId,  serviceException);
                throw new ResponseStatusException(HttpStatus.INTERNAL_SERVER_ERROR, serviceException.getServiceExceptionMessage());
            } else if (serviceException.getException() instanceof IllegalArgumentException) {
                LOGGER.error("The given lecturerId {} is wrong when get week schedule for a lecturer.", lecturerId,  serviceException);
                throw new ResponseStatusException(HttpStatus.BAD_REQUEST, serviceException.getServiceExceptionMessage());
            } else {
                LOGGER.error("There is some error in service layer when get week schedule for a lecturer with id {}.", lecturerId, serviceException);
                throw new ResponseStatusException(HttpStatus.NOT_FOUND, serviceException.getServiceExceptionMessage());
            }
        }
    }
    ...
    public String aroundGetLecturerMonthSchedule(ProceedingJoinPoint proceedingJoinPoint) throws Throwable {
        ...
        try {
            ...
            if (LOGGER.isDebugEnabled()) {            
                LOGGER.debug("The result model of searching  schedule of a month {} for a lecturer with id {} is {}.", monthValue, lecturerId, model.asMap());
            }            
            ...
            if (serviceException.getException() instanceof DAOException) {
                LOGGER.error("There are some errors in dao layer when get schedule of a month {} for a lecturer with id {}.", monthValue, lecturerId,  serviceException);
                throw new ResponseStatusException(HttpStatus.INTERNAL_SERVER_ERROR, serviceException.getServiceExceptionMessage());
            } else if (serviceException.getException() instanceof IllegalArgumentException) {
                LOGGER.error("The given parameters lecturerId = {} and monthValue = {} are wrong when get month schedule for a lecturer.", lecturerId,  monthValue, serviceException);
                throw new ResponseStatusException(HttpStatus.BAD_REQUEST, serviceException.getServiceExceptionMessage());
            } else {
                LOGGER.error("There is some error in service layer when get schedule of a month {} for a lecturer with id {}.", monthValue, lecturerId, serviceException);
                throw new ResponseStatusException(HttpStatus.NOT_FOUND, serviceException.getServiceExceptionMessage());
            }
        }
    }
    ...
    public String aroundGetGroupWeekSchedule(ProceedingJoinPoint proceedingJoinPoint) throws Throwable {
        ...
        try {
            ...
            Model model = (Model) proceedingJoinPoint.getArgs()[1];
            if (LOGGER.isDebugEnabled()) {            
                LOGGER.debug("The result model of searching a week schedule for a group with id {} is {}.", groupId, model.asMap());
            }            
            ...
            if (serviceException.getException() instanceof DAOException) {
                LOGGER.error("There are some errors in dao layer when get week schedule for a group with id {}.", groupId,  serviceException);
                throw new ResponseStatusException(HttpStatus.INTERNAL_SERVER_ERROR, serviceException.getServiceExceptionMessage());
            } else if (serviceException.getException() instanceof IllegalArgumentException) {
                LOGGER.error("The given groupId {} is wrong when get week schedule for a group.", groupId,  serviceException);
                throw new ResponseStatusException(HttpStatus.BAD_REQUEST, serviceException.getServiceExceptionMessage());
            } else {
                LOGGER.error("There is some error in service layer when get week schedule for a group with id {}.", groupId, serviceException);
                throw new ResponseStatusException(HttpStatus.NOT_FOUND, serviceException.getServiceExceptionMessage());
            }
        }
    }
    ...
    public String aroundGetGroupMonthSchedule(ProceedingJoinPoint proceedingJoinPoint) throws Throwable {
        ...
        try {
            ...
            Model model = (Model) proceedingJoinPoint.getArgs()[2];
            if (LOGGER.isDebugEnabled()) {            
                LOGGER.debug("The result model of searching  schedule of a month {} for a group with id {} is {}.", monthValue, groupId, model.asMap());
            }            
            ...
            if (serviceException.getException() instanceof DAOException) {
                LOGGER.error("There are some errors in dao layer when get schedule of a month {} for a group with id {}.", monthValue, groupId,  serviceException);
                throw new ResponseStatusException(HttpStatus.INTERNAL_SERVER_ERROR, serviceException.getServiceExceptionMessage());
            } else if (serviceException.getException() instanceof IllegalArgumentException) {
                LOGGER.error("The given parameters groupId = {} and monthValue = {} are wrong when get month schedule for a lecturer.", groupId,  monthValue, serviceException);
                throw new ResponseStatusException(HttpStatus.BAD_REQUEST, serviceException.getServiceExceptionMessage());
            } else {
                LOGGER.error("There is some error in service layer when get schedule of a month {} for a group with id {}.", monthValue, groupId, serviceException);
                throw new ResponseStatusException(HttpStatus.NOT_FOUND, serviceException.getServiceExceptionMessage());
            }
        }
    }
