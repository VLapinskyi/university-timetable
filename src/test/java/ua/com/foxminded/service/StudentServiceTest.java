...
class StudentServiceTest {
    ...
    void shouldGetAllStudents() {
        ...
        List<Integer> studentIndexes = new ArrayList<>(Arrays.asList(
                1, 2, 3));
        List<String> firstName = new ArrayList<>(Arrays.asList(
                "Iuliia", "Anna", "Tetiana"));
        List<String> lastName = new ArrayList<>(Arrays.asList(
                "Mostunenko", "Sydorenko", "Shcherbak"));
        List<Gender> genders = new ArrayList<>(Arrays.asList(
                Gender.FEMALE, Gender.FEMALE, Gender.FEMALE));
        List<String> phoneNumbers = new ArrayList<>(Arrays.asList(
                "+380136498753", "+380567365478", "+380698541235"));
        List<String> emails = new ArrayList<>(Arrays.asList(
                "mostunenko@test.com", "sydorenko@test.com", "shcherbak@test.com"));
    ...
    void shouldGetStudentsFromGroup() {
        ...
        List<Integer> studentIndexes = new ArrayList<>(Arrays.asList(
                1, 2, 3));
        List<String> firstName = new ArrayList<>(Arrays.asList(
                "Natalia", "Tetiana", "Alla"));
        List<String> lastName = new ArrayList<>(Arrays.asList(
                "Fedoriaka", "Basiuk", "Matviichuk"));
        List<Gender> genders = new ArrayList<>(Arrays.asList(
                Gender.FEMALE, Gender.FEMALE, Gender.FEMALE));
        List<String> phoneNumbers = new ArrayList<>(Arrays.asList(
                "+380846498753", "+380585365478", "+380654541235"));
        List<String> emails = new ArrayList<>(Arrays.asList(
                "fedoriaka@test.com", "basiuk@test.com", "matviichuk@test.com"));
    ...
    void shouldGenerateLogsWhenStudentIsNullWhileCreate() {
        ...
        List<String> expectedMessages = new ArrayList<>(Arrays.asList(
                "Try to create a new person: " + student + ".",
    ...
    void shouldGenerateLogsWhenGetAll() {
        ...
        List<String> lastNames = new ArrayList<>(Arrays.asList(
                "Perebyinis", "Melnyk", "Televna"));
        List<Gender> genders = new ArrayList<>(Arrays.asList(
                Gender.FEMALE, Gender.FEMALE, Gender.FEMALE));
        List<String> phoneNumbers = new ArrayList<>(Arrays.asList(
                "+380359874521", "+380421365879", "+380159765432"));
        List<String> emails = new ArrayList<>(Arrays.asList(
                "perebyinis@gmail.com", "melnyk@gmail.com", "televna@gmail.com"));
        List<Group> groups = new ArrayList<>(Arrays.asList(
    ...
    void shouldGenerateLogsWhenStudentIdIsZeroWhileUpdate() {
        ...
        List<Level> expectedLevels = new ArrayList<>(Arrays.asList(
                Level.DEBUG, Level.ERROR));
        List<String> expectedMessages = new ArrayList<>(Arrays.asList(
                "Try to update a person: " + student + ".",
    ...
    void shouldGenerateLogsWhenUpdate() {
        ...
        List<String> expectedMessages = new ArrayList<>(Arrays.asList(
                "Try to update a person: " + student + ".",
                "The object " + student + " was updated."));
    ...
    void shouldGenerateLogsWhenStudentIdIsNegativeWhileGetStudentsFromGroup() {
        ...
        List<Level> expectedLevels = new ArrayList<>(Arrays.asList(
                Level.DEBUG, Level.ERROR));
        List<String> expectedMessages = new ArrayList<>(Arrays.asList(
                "Try to get students from a group by id: " + testId + ".",
    ...
    void shouldGenerateLogsWhenGetStudentsFromGroup() {
        ...
        List<String> firstNames = new ArrayList<>(Arrays.asList(
                "Olha", "Anna", "Iana"));
        List<String> lastNames = new ArrayList<>(Arrays.asList(
                "Koval", "Koval", "Polishchuk"));
        List<Gender> genders = new ArrayList<>(Arrays.asList(
                Gender.FEMALE, Gender.FEMALE, Gender.FEMALE));
        List<String> phoneNumbers = new ArrayList<>(Arrays.asList(
                "+380456352741", "+380429865321", "+380456321456"));
        List<String> emails = new ArrayList<>(Arrays.asList(
                "okoval@gmail.com", "akoval@gmail.com", "ipolishchuk@gmail.com"));
