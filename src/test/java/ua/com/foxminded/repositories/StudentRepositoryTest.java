...
class StudentRepositoryTest {
    ...
    void shouldThrowRepositoryExceptionWhenDataAccessExceptionWhileSave() {
        ...
        RuntimeException exception = assertThrows(RepositoryException.class, () -> studentRepository.save(student));
    ...
    void shouldThrowRepositoryExceptionWhenResultIsNullPointerExceptionWhileFindById() {
        int testId = 1;
        RuntimeException exception = assertThrows(RepositoryException.class, () -> studentRepository.findById(testId));
    ...
    void shouldThrowRepositoryExceptionWhenDataAccessExceptionWhileDeleteById() {
        Integer testId = null;
        RuntimeException exception = assertThrows(RepositoryException.class, () -> studentRepository.deleteById(testId));
